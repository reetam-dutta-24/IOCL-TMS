"use strict";(()=>{var e={};e.id=9518,e.ids=[9518],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},61282:e=>{e.exports=require("child_process")},84770:e=>{e.exports=require("crypto")},80665:e=>{e.exports=require("dns")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},98216:e=>{e.exports=require("net")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},82452:e=>{e.exports=require("tls")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},9575:(e,r,i)=>{i.r(r),i.d(r,{originalPathname:()=>m,patchFetch:()=>x,requestAsyncStorage:()=>c,routeModule:()=>l,serverHooks:()=>g,staticGenerationAsyncStorage:()=>u});var t={};i.r(t),i.d(t,{POST:()=>p});var o=i(73278),s=i(45002),a=i(54877),n=i(71309);let d=i(56742).createTransport({host:process.env.SMTP_HOST||"smtp.gmail.com",port:587,secure:!1,auth:{user:process.env.SMTP_USER,pass:process.env.SMTP_PASS}});async function p(e){try{let{to:r,type:i,data:t}=await e.json(),o="",s="";"ACCESS_APPROVED"===i?(o="\uD83C\uDF89 Access Approved - Welcome to IOCL TAMS!",s=`
        <!DOCTYPE html>
        <html>
        <head>
          <meta charset="utf-8">
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Dear <strong>${t.firstName} ${t.lastName}</strong>,</p>
              ...
              <div class="credentials-box">
                ...
                <p><strong>Employee ID:</strong> ${t.employeeId}</p>
                <p><strong>Temporary Password:</strong> <code>${t.defaultPassword}</code></p>
      ...
      `):"ACCESS_REJECTED"===i&&(o="❌ Access Request Update - IOCL TAMS",s=`
        <!DOCTYPE html>
        <html>
        <head>
          <meta charset="utf-8">
            ...
            <div class="content">
              ...
              ${t.comment?`
                <div style="background: #fef2f2; border: 1px solid #fecaca; padding: 20px; border-radius: 8px; margin: 20px 0;">
                  <strong>📝 Admin Comment:</strong><br>
                  <p style="margin-top: 10px;">${t.comment}</p>
                </div>
              `:""}
