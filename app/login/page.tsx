...
export default function LoginPage() {
  ...
  const handleGoogleLoginClick = () => {
    if (window.google) {
      ...
      setError("Google login is not available. Please try regular login.")
    }
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 flex items-center justify-center p-4 animate-fade-in">
      <div className="w-full max-w-md space-y-6">
        ...
        {/* Demo Credentials */}
        <Card className="animate-slide-in-up animate-delay-1100 border-blue-200 bg-blue-50">
          <CardContent className="pt-6">
            <h3 className="font-semibold text-blue-900 mb-3">Demo Credentials</h3>
            <div className="grid grid-cols-1 gap-2 text-sm">
              <div className="flex justify-between">
                <span className="text-blue-700">L&D HoD:</span>
                <span className="font-mono text-blue-800">EMP001 / demo123</span>
              </div>
              <div className="flex justify-between">
                <span className="text-blue-700">L&D Coordinator:</span>
                <span className="font-mono text-blue-800">EMP002 / demo123</span>
              </div>
              <div className="flex justify-between">
                <span className="text-blue-700">Department HoD:</span>
                <span className="font-mono text-blue-800">EMP003 / demo123</span>
              </div>
              <div className="flex justify-between">
        ...
        {/* Help Section */}
        <div className="text-center text-sm text-gray-500 animate-slide-in-up animate-delay-1200">
